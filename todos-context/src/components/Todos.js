...
const Todos = () => {
  ...
  /* PARTIE remplacer par le useReducer */
  ...
  //     id: uuidv4()
  //   }
  //   // setTodos([...todos, newTodo])  / Ajouter dans todosReducer.js" pour l'action "ADD"
  //   display({ type: "ADD", payload: newTodo })
  // }

  // const deleteTodo = (task) => {
  //   // setTodos(todos.filter((el) => el.id !== task.id))  / "Ajouter dans todosReducer.js" pour l'action "DELETE"
